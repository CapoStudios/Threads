...
def drawCredits():
	...
	#Back Button
    screen.blit(pygame.transform.scale2x(blockImg), (btn3.x, btn3.y), (0, 0, 225, 75))
    arrow((0,0,0), (0,0,0), (56, 33), (36, 33), 12, 9)
    arrow((255,255,255), (255,255,255), (53, 33), (33, 33), 12, 9)
...
def updateCredits():
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            if event.button == 1:
                mouseX, mouseY = pygame.mouse.get_pos()
                if btn3.collidepoint((mouseX, mouseY)):
