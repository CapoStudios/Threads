...
#------------------------------------------------------------------------------------------
#My Draw Functions
def arrow(lcolor, tricolor, start, end, trirad, thickness=2):
    rad = math.pi/180
...
def drawGame():
    ...
    if hammer.hasCollideWithPlayer == False:
        ...
        arrow((0,0,0), (0,0,0), (433, 124), (469, 191), 12, 4)
